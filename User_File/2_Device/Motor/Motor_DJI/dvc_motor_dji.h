...
// inline float Get_Power_K_0() const { return POWER_K_0; }
// inline float Get_Power_K_1() const { return POWER_K_1; }
// inline float Get_Power_K_2() const { return POWER_K_2; }
// inline float Get_Power_A()   const { return POWER_A; }
//
// // 返回与 Set_Target_Torque 同单位的“最大力矩指令”(Nm，含减速箱)
// inline float Get_Current_Max() const
// {
//     return (OUT_MAX / CURRENT_TO_OUT) * CURRENT_TO_TORQUE * Gearbox_Rate;
// }
